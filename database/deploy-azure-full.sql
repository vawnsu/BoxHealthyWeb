...
-- Run this while connected to the BoxHealthy database in Azure Query Editor.
...
VALUES
(N'Box Đạm Gà Gạo Lứt', N'Ức gà nướng, trứng luộc, rau củ và cơm gạo lứt đóng gói sẵn, tiện lợi cho bữa chính.', N'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=900&q=80', 65000, 558, 60.9, 44.3, 14.3, 100, N'ACTIVE', 1),
(N'Set Ăn Sáng Healthy', N'Yến mạch, sữa chua, trứng và trái cây theo khẩu phần gọn nhẹ cho buổi sáng.', N'https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=900&q=80', 35000, 470, 21.7, 63.5, 15.6, 100, N'ACTIVE', 2),
(N'Bánh Eat Clean Yến Mạch', N'Bánh yến mạch ít ngọt, dùng như món bán kèm khi đặt box healthy.', N'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=900&q=80', 22000, 311, 12.0, 42.2, 13.1, 100, N'ACTIVE', 3);
...
VALUES
(1, 7, N'Ức gà nướng', N'Protein chính, ít mỡ', 150, 248, 46.5, 0, 5.4, 1),
(1, 8, N'Trứng luộc', N'Bổ sung đạm và chất béo tốt', 55, 85, 7, 0.6, 5.8, 2),
(1, 9, N'Cơm gạo lứt', N'Tinh bột chậm', 150, 166, 3.9, 34.5, 1.3, 3),
(1, 5, N'Bông cải xanh', N'Rau xanh giàu chất xơ', 90, 31, 2.5, 6, 0.3, 4),
(1, 10, N'Sốt mè rang healthy', N'Tăng vị, dùng lượng nhỏ', 20, 28, 1, 3.2, 1.5, 5),
(2, 11, N'Yến mạch', N'Tinh bột tốt cho bữa sáng', 55, 214, 9.3, 36.4, 3.8, 1),
(2, 12, N'Sữa chua không đường', N'Hỗ trợ tiêu hóa', 100, 61, 3.5, 4.7, 3.3, 2),
(2, 8, N'Trứng luộc', N'Đạm nhanh, no lâu', 55, 85, 7, 0.6, 5.8, 3),
(2, 13, N'Chuối', N'Bổ sung năng lượng', 80, 71, 0.9, 18.4, 0.2, 4),
(2, 14, N'Hạt chia', N'Chất xơ và omega-3', 8, 39, 1.3, 3.4, 2.5, 5),
(3, 15, N'Yến mạch cán dẹt', N'Nền bánh giàu chất xơ', 35, 136, 5.9, 23.2, 2.4, 1),
(3, 16, N'Chuối chín', N'Tạo vị ngọt tự nhiên', 55, 49, 0.6, 12.6, 0.2, 2),
(3, 17, N'Bơ đậu phộng', N'Tăng vị béo, dùng lượng nhỏ', 12, 71, 3, 2.4, 6, 3),
(3, 18, N'Hạnh nhân lát', N'Chất béo tốt', 8, 46, 1.7, 1.7, 4, 4),
(3, 19, N'Bột cacao', N'Tạo vị chocolate nhẹ', 4, 9, 0.8, 2.3, 0.5, 5);
